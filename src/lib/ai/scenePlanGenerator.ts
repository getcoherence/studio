...
export async function generateScenePlan(
	...
	const prompt = [
		...
		`      "animation": "chars|words|scale|clip|gradient|glitch|blur-in|bounce|wave|typewriter|staccato|split|drop|scramble",`,
		...
		`      "backgroundEffect": "flowing-lines | drifting-orbs | mesh-shift | particle-field | grain | pulse-grid | aurora | spotlight | wave-grid | gradient-wipe | bokeh | liquid-glass | none",`,
		`      "backgroundEffectColors": ["#2563eb","#7c3aed","#06b6d4"],`,
		`      "transitionOut": "fade | slide-left | slide-right | slide-up | slide-down | wipe-left | wipe-right | wipe-up | wipe-down | zoom-morph | cut",`,
		...
		"- 16-22 scenes total. FAST CUTS are the key to energy. 3 seconds is TOO LONG.",
