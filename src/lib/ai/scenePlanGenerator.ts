...
export async function generateScenePlan(
	...
	const prompt = [
		...
		"",
		"IMPORTANT: Introduce the PRODUCT NAME by scene 2-3. The viewer needs to know WHO",
		"is talking to them early. Don't wait until scene 5-6 to reveal the brand. Pattern:",
		"  Scene 1-2: Hook (the problem)  →  Scene 2-3: Brand reveal (Meet [Product])  →  Then features/proof",
		"Use `camera-text` for the brand reveal — it's the premium 'Meet [Product]' moment.",
		"",
		"First, CLASSIFY the company based on the captured data and choose the BEST narrative framework:",
		"",
		"### Framework A: Problem → Brand → Proof → Outcome (general SaaS, productivity tools)",
		"1. HOOK (1-2 scenes): Name the viewer's pain. 'Your tools work against each other.'",
		"2. BRAND REVEAL (1 scene): Introduce the product. 'Meet [Product].' Use camera-text.",
		"3. VALUE (2-3 scenes): Show what the product does. Aspirational, not technical.",
		"4. PROOF (2-3 scenes): Show key capabilities, stats, social proof. Vary visuals.",
		"5. OUTCOME (1 scene): What life looks like after. Confident, clean.",
		"6. CTA (1 scene): Product name + call to action.",
		"",
		"### Framework B: Chaos → Brand → Clarity (infrastructure, AI, ops, data platforms)",
		"1. HOOK (1-2 scenes): Show overwhelming complexity. 'Too many tools. Too many tabs.'",
		"2. BRAND REVEAL (1 scene): 'Meet [Product].' The calm after the storm. Use camera-text.",
		"3. CLARITY (2-3 scenes): Show the simplified system. Modular, organized.",
		"4. PROOF (1-2 scenes): Stats, integrations, social proof.",
		"5. OUTCOME (1 scene): Clean, unified result.",
		"6. CTA (1 scene): Product name + call to action.",
		"",
		"### Framework C: Old Way → Brand → New Way (disruptive tools, new categories)",
		"1. HOOK (1-2 scenes): 'The old way is broken.' Bold, confrontational.",
		"2. BRAND REVEAL (1 scene): 'Meet [Product]. There's a better way.' Use camera-text.",
		"3. NEW WAY (2-3 scenes): Show the modern approach. Fast, elegant, powerful.",
		"4. PROOF (1-2 scenes): Before/after comparison, metrics.",
		"5. CTA (1 scene): Product name + call to action.",
		"",
		"### Framework D: Brand → Capability → Proof (enterprise, security, fintech)",
		"1. BRAND INTRO (1-2 scenes): Lead with credibility. Product name + tagline.",
		...
		"- Scene durations — GENEROUS. Viewers need time to read and absorb each scene:",
		"  - IMPACT scenes: 80-110 frames (2.7-3.7 sec) — single word or short phrase, let it land",
		"  - STANDARD scenes: 110-150 frames (3.7-5 sec) — headline with animation, viewer needs time to READ",
		"  - RICH scenes: 150-200 frames (5-6.7 sec) — before-after, metrics-dashboard, chat-narrative, icon-showcase, data-flow-network, scrolling-list (scenes with multiple elements that animate sequentially)",
		"  - GHOST-HOOK scenes: 90-120 frames each (viewers must read the full sentence fragment)",
		"- MAXIMUM duration for ANY scene is 240 frames (8 sec). Use this for very content-dense scenes.",
		"- RULE OF THUMB: if a scene has more than 5 words of text, it needs at least 120 frames. More than 15 words → at least 160 frames.",
		"- Under 3 seconds per scene feels rushed and unreadable. 3-5 seconds is the sweet spot for most scenes.",
		"- NEVER make all scenes the same duration. That's what makes it feel robotic.",
		"- Ghost-hook scenes should each be 90-120 frames (viewers need time to read each fragment).",
		"",
