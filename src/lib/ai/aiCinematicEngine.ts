...
function buildSystemPrompt(): string {
	return [
		...
		"6. ALWAYS define const SCENE_FRAMES = 75 (2 seconds per scene) and use it consistently.",
		"",
		...
		"## Pacing",
		"",
		"- Each scene: 70-90 frames (2.3-3.0 seconds). Give animations time to complete and breathe.",
		"- Total: 10-14 scenes.",
		"- Use TransitionSeries with fade/slide/wipe transitions between scenes (8-12 frames each).",
		"",
		"## Output",
		"",
		...
		"- Define const SCENE_FRAMES = 75 at the top, then const totalDuration = numberOfScenes * SCENE_FRAMES",
