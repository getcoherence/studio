...
function buildSystemPrompt(): string {
	return [
		...
		"## Pacing",
		"",
		"- Each scene: 85-100 frames (2.8-3.3 seconds). Give animations time to complete and let viewers READ the text.",
		"- Total: 10-14 scenes.",
		...
		"- Define const SCENE_FRAMES = 90 at the top, then const totalDuration = numberOfScenes * SCENE_FRAMES",
